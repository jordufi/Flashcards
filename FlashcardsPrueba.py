...
class FlashcardApp:
    def __init__(self, root):
        ...
        # Configura la vinculación de eventos de teclado
        self.root.bind("<Right>", self.next_question)
        self.root.bind("<space>", self.show_answer)
    ...
    def show_answer(self, event=None):
            self.flashcard_image2 = self.load_and_resize_image(flashcards[self.current_flashcard]["respuesta"])
